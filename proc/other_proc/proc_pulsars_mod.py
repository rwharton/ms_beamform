...
if __name__ == "__main__":
    ...
    datdir = '/hercules/results/rwharton/fastvis_gc/ms_data/model_sub'
    infile = '%s/part2_test.ms' %datdir
    basename = 'part2_mod'
    src_base = "MJD57519"
    logfile = "%s.log" %basename

    beamlist_file = '/hercules/results/rwharton/fastvis_gc/proc/psr_beams.npy'
