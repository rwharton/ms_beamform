...
if __name__ == "__main__":
    ...
    datdir = '/data/M70-2/polcal/no_apply_cal_2'
    #datdir = '/data/M70-2/polcal/apply_all_2/data'
    #inbase = '3C286_avg10'
    inbase = '3C286_nocal'
    basename = 'donly'
    src_base = "donly"
    ...
    beamlist_file = '/data/M70-2/polcal/no_apply_cal_2/beams/polcal_beam.npy'
